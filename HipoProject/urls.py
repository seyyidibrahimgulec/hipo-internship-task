...
from recipes.views import ListCreateIngredientView, ListCreateRecipeView, RetrieveUpdateDestroyRecipeView
...
urlpatterns = [
    ...
    path('api/recipes/<int:pk>/', RetrieveUpdateDestroyRecipeView.as_view(), name='recipe-detail')
