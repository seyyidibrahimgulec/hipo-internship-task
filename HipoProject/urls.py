...
from recipes.views import ListCreateIngredientView, ListCreateRecipeView, RecipeDetailView, LikeDetailView
...
urlpatterns = [
    ...
    path('api/recipes/<int:pk>/likes/', LikeDetailView.as_view(), name='like-recipe'),
