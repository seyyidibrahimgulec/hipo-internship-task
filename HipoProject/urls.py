...
urlpatterns = [
    ...
    path('new_recipe/', login_required(NewRecipeView.as_view()),
         name='new_recipe'),
    path('update_recipe/<int:pk>/', login_required(UpdateRecipeView.as_view()),
         name='update_recipe'),
    path('delete_recipe/<int:pk>/', login_required(DeleteRecipeView.as_view()),
         name='delete_recipe'),
